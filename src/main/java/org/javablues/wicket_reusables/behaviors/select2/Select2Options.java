...
public class Select2Options implements Serializable {
  ...
  protected String getOptions() {
    ...
    if (containerCssClass != null) {
      options
        .append("containerCssClass:'")
        .append(containerCssClass)
        .append("',");
    }
    if (dropdownCssClass != null) {
      options
        .append("dropdownCssClass:'")
        .append(dropdownCssClass)
        .append("',");
    }
    if (!closeOnSelect) {
    ...
    if (minimumResultsForSearch != 0) {
      options
        .append("minimumResultsForSearch:")
        .append(minimumResultsForSearch)
        .append(",");
    }
    if (minimumInputLength != 0) {
      options
        .append("minimumInputLength:")
        .append(minimumInputLength)
        .append(",");
    }
    if (maximumInputLength != 0) {
      options
        .append("maximumInputLength:")
        .append(maximumInputLength)
        .append(",");
    }
    if (maximumSelectionLength != 0) {
      options
        .append("maximumSelectionLength:")
        .append(maximumSelectionLength)
        .append(",");
    }
