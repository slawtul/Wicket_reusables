...
public class PopoverBehaviorTest extends WicketBaseTest {
    ...
    public void popoverRenderedWithDefaultValues() {
        Panel panel = createTestPanel("panel",
                "<wicket:panel><input type=\"submit\" wicket:id=\"register\"/></wicket:panel>");
        ...
        String expectedMarkup = new StringBuilder()
                ...
                .append("<wicket:panel>")
                .append("<input type=\"submit\" wicket:id=\"register\" name=\"panel:register\" ")
                .append("id=\"register1\" ")
                .append("data-toggle=\"popover\" title=\"Register user\" ")
                .append("data-content=\"Please click to register user\"/>")
                .append("</wicket:panel>")
                .append("</span>")
                .toString();

        assertEquals("Rendered panel markup does not contain correct popover markup",
    ...
    public void popoverRenderedWithUserSettings() {
        ...
        String expectedMarkup = new StringBuilder()
                ...
                .append("data-toggle=\"popover\" title=\"Register user\" ")
                .append("data-content=\"Please click to register user\" ")
                .append("data-trigger=\"click\" data-placement=\"bottom\" data-delay=\"10\" ")
                .append("data-offset=\"100\" ")
