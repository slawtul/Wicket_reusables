...
public class PopoverBehaviorTest extends WicketBaseTest {
    ...
    public void popoverRenderedWithDefaultValues() {
        Panel panel = createTestPanel("panel",
            "<wicket:panel><input type=\"submit\" " +
                "wicket:id=\"register\"/></wicket:panel>");
        ...
        String expectedMarkup = new StringBuilder()
            ...
            .append("<wicket:panel>")
            .append("<input type=\"submit\" wicket:id=\"register\" " +
                "name=\"panel:register\" ")
            .append("id=\"register1\" ")
        ...
        assertEquals(
            "Rendered panel markup does not contain correct popover " +
                "markup",
    ...
    public void popoverRenderedWithEscapedText() {
        ...
        assertEquals(
            "Rendered panel markup does not contain correct popover markup",
            expectedMarkup, actualMarkup);
    }
}
